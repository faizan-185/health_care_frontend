              ...
              child: Column(
                children: [
                  buildMenuItem(
                    ...
                    onClicked: () {
                      Navigator.pushNamedAndRemoveUntil(context, "/VendorHomeScreen", (route) => false);
                    },
                  ),
                  ...
                  buildMenuItem(
                    ...
                    onClicked: () => Navigator.pushNamed(context, "/AllPosts"),
                  ),
                  const SizedBox(height: 16),
                  buildMenuItem(
                    text: 'My Responses',
                    icon: FontAwesomeIcons.commentDollar,
                    onClicked: () => Navigator.pushNamed(context, "/MyResponses"),
                  ),
