        ...
        children: [
          ...
          medicines.length != 0 && orderList.length != 0 ? SizedBox(
            ...
            child: VeridoPrimaryButton(
              ...
              onPressed: () {
                Navigator.push(context, new MaterialPageRoute(builder: (context) => ConfirmOrder(orderList: orderList, bill: total.toStringAsFixed(2), pharmacyId: widget.pharmacy.pharmacyId, pname: widget.pharmacy.pharmacyName, pharmacy: widget.pharmacy,)));
              },
            ),
          ) : SizedBox(),
          SizedBox(height: 15,),
