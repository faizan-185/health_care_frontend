                ...
                GestureDetector(
                  ...
                  child: AbsorbPointer(
                    child: CategoryCard(color: color[0], lightColor: lightColor[0], title: "Pending",
                      subtitle: pending_appointments.length.toString()+" Appointments", titleStyle: authSubTextStyle1,
                ...
                GestureDetector(
                  ...
                  child: AbsorbPointer(
                    child: CategoryCard(color: color[1], lightColor: lightColor[1], title: "Upcoming",
                        subtitle: "${upcoming_appointments.length} Appointments", titleStyle: authSubTextStyle1, subtitleStyle: floatingButtonText),
                  ),
                ),
